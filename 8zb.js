...
var storage = storages.create("图色助手Pro Max");
...
function 多点找色测试(colorArr) {
    ...
    var p = images.findMultiColors(imgList[pictureAttribute.image.select].img, colorArr[0], colorArr[1], {
        threshold: [4],
    });
...
function 取色() {
    colorList.push({x: nowColor.x, y: nowColor.y, color: nowColor.colorString});
};
